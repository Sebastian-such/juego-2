...
def jugar_adivina_el_numero():
 ...
 if intento < numero_secreto: mensaje.set("El número es mayor ⬆")
 elif intento > numero_secreto:mensaje.set("El número es menor ⬇")
 else:mensaje.set("¡Felicidades! 🎉 Has adivinado el número.")
...
entrada.pack()
boton_verificar = tk.Button(ventana, text="Comprobar", command=jugar_adivina_el_numero)
